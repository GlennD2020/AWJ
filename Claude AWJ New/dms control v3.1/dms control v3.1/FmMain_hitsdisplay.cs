...
namespace dms_control_v3
{
    ...
    public partial class FmMain : Form
    {
        ...
        public FmMain(GlobalConfigurations _cfg)
        {
            ...
            // K9: Refresh hits/sec display when grid data changes
            if (dgvBands != null)
            {
        ...
        private void CreateGuardBandSettingsBox()
        {
            ...
            lblDwellMs.Text = "ms";
            lblDwellMs.Location = new Point(530, 53);
            lblDwellMs.Size = new Size(22, 18);
        ...
        /// </summary>
        /// <summary>
        /// Counts bands in the grid that have Active checkbox ticked.
        /// If no Active column exists, counts all non-empty rows.
        /// </summary>
        ...
        /// <summary>
        /// Lightweight queue check for fast hopping.
        /// Only waits if queue is backed up beyond threshold.
        /// Does NOT drain fully - just prevents runaway buildup.
        /// </summary>
        ...
        private void ReconfigureDDSBandParams(BandConfiguration band)
        {
            try
            {
                ...
                ThrottleCommandQueue(2);  // Brief wait for DDS commands
                ...
                if (usePulseMode)
                {
                    ...
                    for (int cycle = 0; cycle < pulseCycles && isJamming; cycle++)
                    {
                        ...
                        for (int i = 0; i < allBands.Count && isJamming; i++)
                        {
                            ...
                            Thread.Sleep(dwellTimeMs);  // User-adjustable dwell per band
                        }
        ...
        private void HopToFrequency(double frequencyMHz)
        {
            try
            {
                ...
                // PLL update - throttle if queue backed up
                AddSequences(new SequenceSetSweepLoParameters(ltTxCommand, null,
                    (float)freqHz, 0, 1, 0, 0, 0));
                ThrottleCommandQueue(3);  // Only wait if >3 commands queued
